...
class SpeedTestCLIWrapper {
    ...
    test(path){
        ...
        return child_process.exec(`${self.options.speedtest_cli_path || path || 'speedtest-cli'} --version`, self.options.exec_options)
            .then(result => {
                ...
                return child_process.exec(`${self.options.speedtest_cli_path || path || 'speedtest-cli'} --json`, self.options.exec_options);
            }).then(result => {
